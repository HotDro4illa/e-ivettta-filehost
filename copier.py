...
for directory in dirlist:
    ...
    videos = [{"file": i, "thumbnail": f'thumb_{file}.jpg'} for i in dir_mat_files if 'mp4' in i]
    photos = [{"file": i, "thumbnail": f'thumb_{file}.jpg'} for i in dir_mat_files if 'jpg' in i]
    tiktok = [{"file": i, "thumbnail": f'thumb_{file}.jpg'} for i in dir_all_files if 'mp4' in i and 'tiktok' in i and "thumb" not in i]
