...
for directory in dirlist:
    ...
    videos = [{"file": i, "thumbnail": f'thumb_{file}.jpg', "date": {"year": filename.split('_')[0].split('-')[0], "month":filename.split('_')[0].split('-')[1], "day":filename.split('_')[0].split('-')[2], "hour":filename.split('_')[1].split('-')[0], "minute":filename.split('_')[1].split('-')[1], "second":filename.split('_')[1].split('-')[2]}} for i in dir_mat_files if 'mp4' in i]
    photos = [{"file": i, "thumbnail": f'thumb_{file}.jpg', "date": {"year": filename.split('_')[0].split('-')[0], "month":filename.split('_')[0].split('-')[1], "day":filename.split('_')[0].split('-')[2], "hour":filename.split('_')[1].split('-')[0], "minute":filename.split('_')[1].split('-')[1], "second":filename.split('_')[1].split('-')[2]}} for i in dir_mat_files if 'jpg' in i]
    tiktok = [{"file": i, "thumbnail": f'thumb_{file}.jpg', "date": {"year": filename.split('_')[0].split('-')[0], "month":filename.split('_')[0].split('-')[1], "day":filename.split('_')[0].split('-')[2], "hour":filename.split('_')[1].split('-')[0], "minute":filename.split('_')[1].split('-')[1], "second":filename.split('_')[1].split('-')[2]}} for i in dir_all_files if 'mp4' in i and 'tiktok' in i and "thumb" not in i]
