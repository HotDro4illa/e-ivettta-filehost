...
start H:\Portable\goodbyedpi-0.2.2\x86_64\goodbyedpi.exe -p -r -s -m -f 2 -k 2 -n -e 2 -a -w --allow-no-sni --auto-ttl --wrong-chksum --wrong-seq --reverse-frag --max-payload --dns-addr 77.88.8.8 --dns-port 1253
cd insta
